...
- 阶段三：已在 PR #2 形成 Beta 候选，包含批量生产、模板库、自动卡点、素材库、快闪书封逐本替换、可视化编辑器、本地服务和回归测试。
- 阶段五：已开始桌面封装，软件命名为 **水星视频模板**，新增 Electron 桌面壳与 Windows NSIS 安装包配置。
...
- `docs/stage-execution-backlog.md`：后续阶段立项、阶段闸门和执行台账。
